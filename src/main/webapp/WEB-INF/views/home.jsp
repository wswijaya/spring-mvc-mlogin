...
<body>
    ...
    <div id="sencha-app">
        ...
        <div id="sencha-views">
			<script type="text/javascript" src="<c:url value="/resources/js/app/views/Dashboard.js" />"></script>
			<script type="text/javascript" src="<c:url value="/resources/js/app/views/Viewport.js" />"></script>
        </div>
        
        <!-- Place your controller files here -->
        <div id="sencha-controllers">
			<script type="text/javascript" src="<c:url value="/resources/js/app/controllers/DashboardController.js" />"></script>
        </div>
    </div>
